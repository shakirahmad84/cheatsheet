...
function alpha_bootstrapping()
{
    ...
    add_theme_support('stomstom-header-uploads');
...
{
    wp_enqueue_style('font-awesome', get_template_directory_uri().'/assets/fonts/font-awesome.css', array(), false, 'all');
...
//	'paged'          => $paged,
    ...
    ************************************/
    ...
    function custom_image_gallery()
    {
        ...
        register_taxonomy('custom_gallery_taxonomy', 'custom_gallery', array(
            'labels' => array(
                'name' => 'Categories',
            ),
            'public' => true,
    ...
    //Show category name
    $custom_categoryes = get_the_terms(get_the_ID(), 'custom_gallery_taxonomy');
    foreach($custom_categoryes as $custom_category){
        $gallery_category =  $custom_category->name;

        $custom_category_links = get_term_link($custom_category, 'custom_gallery_taxonomy');

        echo '<a href="'.$custom_category_links.'">'. $gallery_category .'</a>';
    }
...
**********************/
/*
WP_Customize_Manager  // Main Class
add_setting()  // Method
add_section()  // Method
add_control()  // Method
$wp_customize  //Object
...
?>
<?php
// make a file named woocommerce.php to root folder and copy page.php code to woocommerce.php like below
get_header();
?>
 ...
 ***** Plugin Development *****
 ******************************/
// change false to true on wp-config.php
define( 'WP_DEBUG', true );

// Plugin Header
/**
 * Plugin Name:       My Basics Plugin
 * Plugin URI:        https://nixsit.com/plugins/the-basics/
